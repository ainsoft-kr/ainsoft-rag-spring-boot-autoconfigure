  ...
  <section class="grid">
    <article class="panel">
      ...
      <div class="stack">
        ...
        <div class="actions"><button id="btn-documents-refresh">Refresh Documents</button></div>
    ...
    <article class="panel">
      <div class="panel-header"><div><h2>Detail Workspace</h2><p>선택 문서의 상세 정보와 운영 액션을 한 카드에서 처리합니다.</p></div></div>
      <div class="stack">
        <div class="dual">
    ...
    <article class="panel full">
      <div class="panel-header"><div><h2>Document Summary</h2><p>문서 수, 청크 수, content kind, source 분포를 요약합니다.</p></div></div>
      <div class="analytic-grid" id="document-analytics"></div>
      <div id="document-bars"></div>
    </article>

    <article class="panel full">
      <div class="panel-header"><div><h2>Chunk Timeline</h2><p>선택한 문서의 chunk/page/offset 흐름을 타임라인으로 확인합니다.</p></div></div>
      <div id="document-timeline"></div>
    </article>

    <article class="panel full">
      <div class="panel-header"><div><h2>Document Spotlight</h2><p>선택 문서의 ACL, metadata, source, chunk 구성을 카드형으로 요약합니다.</p></div></div>
      <div id="document-detail-cards"></div>
    </article>

    <article class="panel full">
      <div class="panel-header"><div><h2>Document Feeds</h2><p>목록, 상세, 액션 응답, source preview를 나란히 봅니다.</p></div></div>
      <div class="grid">
        <div class="stack"><strong>Documents</strong><pre id="output-documents">{'{}'}</pre></div>
        <div class="stack"><strong>Document Detail</strong><pre id="output-document-detail">{'{}'}</pre></div>
        <div class="stack"><strong>Action Response</strong><pre id="output-document-action">{'{}'}</pre></div>
        <div class="stack"><strong>Source Preview</strong><pre id="output-source-preview">{'{}'}</pre></div>
      </div>
    </article>
  </section>
</AdminPage>
