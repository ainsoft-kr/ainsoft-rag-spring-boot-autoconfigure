        ...
        <div style="display: flex; align-items: center;">
          ...
          <span class="help-icon">?
            <div class="tooltip">
              ...
              <p>텍스트 문서는 빠르게 업서트하고, incremental 설정에 따라 중복을 건너뜁니다.</p>
              <h3>Incremental</h3>
              <p>같은 tenant와 docId의 내용이 같으면 `skipped`로 빠집니다.</p>
              <h3>ACL</h3>
              <p>comma 또는 줄바꿈 기준 principal 목록을 넣습니다.</p>
              <h3>Metadata</h3>
              <p>surface, category, source 같은 운영 라벨을 붙일 수 있습니다.</p>
            </div>
          </span>
        </div>
        <p>Text ingest 작업은 Job History에 자동 기록됩니다.</p>
      </div>
      <div class="stack">
        <div class="triple">
        ...
        <div class="triple">
          <label>Incremental Ingest<input id="ingest-incremental" type="checkbox" checked style="width: 24px; height: 24px; margin-top: 8px;" /></label>
          <label>Metadata (`key=value`)<textarea id="ingest-metadata" style="min-height: 80px;">surface=admin
category=notes</textarea></label>
          <label>Text<textarea id="ingest-text" style="min-height: 80px;">Ainsoft RAG admin console document.</textarea></label>
        </div>
        <div class="actions">
          <button id="btn-ingest">Ingest Text</button>
        </div>
